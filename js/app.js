import { CARS, TRACKS, UPGRADES, PRIZE, POINTS, DRIVERS, QUALIFY } from "./data.js?v=202609241638";
import { AudioBus } from "./audio.js?v=202609241638";
import { GameEngine } from "./engine.js?v=202609241638";
import { getModo } from "./modo.js?v=202609241638";
...
async function boot() {
  ...
  try {
    const { tryCreateRenderer3D, showWebglFallbackNote } = await import("./render3d.js?v=202609241638");
